...
milestone1: src/main.c src/dijkstra.c src/gui.c src/parser.c
	$(CC) $(CFLAGS) src/main.c src/dijkstra.c src/gui.c src/parser.c src/graph.c -o dijkstra $(LIBS)

# Milestone 2 & 3: Requirement is an executable named 'sim'
milestone2: milestone3
milestone3: src/main.c src/dijkstra.c src/gui.c src/parser.c src/graph.c	
